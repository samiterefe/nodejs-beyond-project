      ...
      <div className="isolate bg-white  ">
        <main>
          <div className="h-[28rem]   md:h-[40rem]">
            ...
            <div
              class="absolute inset-x-[15%] lg:-mt-[48rem]  md:-mt-[48rem]  sm:-mt-[32rem] -mt-[25rem]  md:-mt-[48rem] py-5 text-center text-white "
              data-aos="zoom-in"
              data-aos-duration="2000"
            >
              <div class="relative px-2 lg:px-8 ">
                <div class="mx-auto max-w-2xl pt-24  md:pt-60 sm:pt-48 lg:py-64">
                  ...
                  <div class="text-center sm:-mx-0 -mx-12   ">
                    <h1 class="text-2xl    font-bold tracking-tight text-white-900 md:text-5xl lg:text-6xl sm:text-4xl">
                      Delivering organic <br /> powders
                    </h1>
                    <p class="mt-6 text-lg leading-8 hidden lg:block text-white-600">
                      For a healthy, balanced,accessible and affordable
                      lifestyle.
                    </p>
